...
```json
{
  ...
  "simple_combined_median_aligned_rho": 0.3656981663714967,
  "max_learned_minus_disagreement": -0.003890635165828882,
  "n_genes_ok": true
}
```
...
| G8 | PASS | simple_combined median aligned rho=0.3657 |
| G9 | FAIL | max learned-disagreement=-0.0039 |
