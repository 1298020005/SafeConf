...
```json
{
  ...
  "simple_combined_median_aligned_rho": 0.3387385861009994,
  "max_learned_minus_disagreement": 0.44414874633327395,
  "n_genes_ok": false
}
```
...
| G8 | PASS | simple_combined median aligned rho=0.3387 |
| G9 | PASS | max learned-disagreement=0.4441 |
