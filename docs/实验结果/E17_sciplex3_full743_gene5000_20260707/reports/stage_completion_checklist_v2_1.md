...
```json
{
  ...
  "simple_combined_median_aligned_rho": 0.6743173125922279,
  "max_learned_minus_disagreement": 0.1986059347469089,
  "n_genes_ok": true
}
```
...
| G8 | PASS | simple_combined median aligned rho=0.6743 |
| G9 | PASS | max learned-disagreement=0.1986 |
