...
```json
{
  ...
  "simple_combined_median_aligned_rho": 0.6554115048365793,
  "max_learned_minus_disagreement": 0.20005645719635712,
  "n_genes_ok": false
}
```
...
| G8 | PASS | simple_combined median aligned rho=0.6554 |
| G9 | PASS | max learned-disagreement=0.2001 |
