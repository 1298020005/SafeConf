...
| 条件化方法 | E225跨研究、E226本地校准、E227非线性对照均完成；三个预定开发门均未通过 | 不能称已验证的通用自适应系统 |
...
本次已完成三轮、1840次轻量拟合（160+960+720），使用同一历史开发表，不是1840组独立生物实验。完整可下载图、相对路径、公式说明与复现命令集中在本包；[本次工作记录](./CHANGELOG.md)列出更正原因和Git内容。
